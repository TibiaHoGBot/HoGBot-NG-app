...
local RegisterPremadeNodes            = require('libs/behaviourtree/nodes/nodes')
local ParseBehavior3Project           = require('libs/behaviourtree/behavior3_parser')
...
BehaviourTree.BranchNode              = require('libs/behaviourtree/node_types/branch_node')
BehaviourTree.RunRandom               = require('libs/behaviourtree/node_types/run_random')
BehaviourTree.Parallel                = require('libs/behaviourtree/node_types/parallel')
BehaviourTree.Sequence                = require('libs/behaviourtree/node_types/sequence')
BehaviourTree.SequenceUntilFailure    = require('libs/behaviourtree/node_types/sequence_until_failure')
BehaviourTree.SequenceUntilSuccess    = require('libs/behaviourtree/node_types/sequence_until_success')
BehaviourTree.Decorator               = require('libs/behaviourtree/node_types/decorator')
BehaviourTree.InvertDecorator         = require('libs/behaviourtree/node_types/invert_decorator')
BehaviourTree.AlwaysFailDecorator     = require('libs/behaviourtree/node_types/always_fail_decorator')
BehaviourTree.AlwaysSucceedDecorator  = require('libs/behaviourtree/node_types/always_succeed_decorator')
BehaviourTree.RepeaterDecorator       = require('libs/behaviourtree/node_types/repeater_decorator')
BehaviourTree.RunTimeOutcomeDecorator = require('libs/behaviourtree/node_types/run_time_outcome_decorator')
BehaviourTree.InterruptDecorator      = require('libs/behaviourtree/node_types/interrupt_decorator')
...
g.loadCodeInScope  = imports.loadCodeInScope or function(code, scope)
  local func, err = loadCodeHere(code, nil, "t", scope)
  if func then
    return func
  else
    return nil, err
