declare global {
  ...
  function onWebviewInitalized(_webview: typeof webview): void;
}
...
export type UNodeRoots =
  | IHealthRootNode
  | ICavebotRootNode
  | IPersistenceRootNode
  | ITargetingRootNode;
export type UNodeRules =
  | IHealthRuleNode
  | ICavebotRuleNode
